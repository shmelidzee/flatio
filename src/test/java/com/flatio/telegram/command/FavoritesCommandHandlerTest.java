...
/**
 * Unit tests for {@link FavoritesCommandHandler} (issue #473).
 */
@ExtendWith(MockitoExtension.class)
class FavoritesCommandHandlerTest {

  @Mock
  private FavoritesCallbackHandler favoritesCallbackHandler;

  @InjectMocks
  private FavoritesCommandHandler handler;

  @Test
  void should_delegate_to_callback_handler_when_favorites_command_received_in_private_chat() {
    // Given
    ...
    // Then
    verify(favoritesCallbackHandler).handleCommand(1L, "100", true);
  }
  ...
  void should_pass_private_chat_flag_when_command_sent_outside_private_chat() {
    ...
    // Then
    verify(favoritesCallbackHandler).handleCommand(2L, "200", false);
  }
