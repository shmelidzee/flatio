...
public class OnlinerSaleConnector implements ListingConnector {
  ...
  public OnlinerSaleConnector(@Qualifier("onlinerSaleRestClient") RestClient restClient,
      OnlinerSaleProperties properties, ImageUrlValidator imageUrlValidator) {
  ...
  private void handleFullFetchRateLimit(HttpClientErrorException.TooManyRequests e) {
    ...
    log.warn("Rate limited by Onliner sale API (429) during full fetch: source={}, retryAfterSeconds={} — Resilience4j will back off",
