 ...
 * {@link RealtSaleConnector} and {@link RealtHouseSaleConnector} — all target realt.by. The
 * circuit breaker is dedicated to this connector's category ({@code connector-realt-room-sale})
...
public class RealtRoomSaleConnector implements ListingConnector {
  ...
  @CircuitBreaker(name = "connector-realt-room-sale")
