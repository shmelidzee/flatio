...
public class RealtSaleConnector implements ListingConnector {
  ...
  private void handleFullFetchRateLimit(HttpClientErrorException.TooManyRequests e) {
    ...
    log.warn("Rate limited by realt.by sale (429) during full fetch: source={}, retryAfter={}s — Resilience4j will back off",
  ...
  private void handleDeltaFetchRateLimit(List<RawListing> result, HttpClientErrorException.TooManyRequests e) {
    ...
    log.warn("Rate limited by realt.by sale (429) after collecting {} listing(s) mid-pagination — "
